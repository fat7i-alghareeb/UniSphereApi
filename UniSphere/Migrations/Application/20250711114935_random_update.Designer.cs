...
namespace UniSphere.Api.Migrations.Application
{
    ...
    [Migration("20250711114935_random_update")]
    partial class random_update
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.FacultyAnnouncementImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("FacultyAnnouncementId")
                        .HasColumnType("uuid")
                        .HasColumnName("faculty_announcement_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_faculty_announcement_images");

                    b.HasIndex("FacultyAnnouncementId")
                        .HasDatabaseName("ix_faculty_announcement_images_faculty_announcement_id");

                    b.ToTable("faculty_announcement_images", "uni_sphere");
                });
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.Lecture", b =>
                {
                    ...
                    b.HasIndex("ProfessorId")
                        .HasDatabaseName("ix_lectures_professor_id");

                    b.HasIndex("ScheduleId")
                        .HasDatabaseName("ix_lectures_schedule_id");

                    b.HasIndex("SubjectId")
                        .HasDatabaseName("ix_lectures_subject_id");
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.Material", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("materials", "uni_sphere");
                });
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.Schedule", b =>
                {
                    ...
                    b.HasIndex("MajorId", "Year", "ScheduleDate")
                        .IsUnique()
                        .HasDatabaseName("ix_schedules_major_id_year_schedule_date");
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.SystemController", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_system_controllers");

                    b.ToTable("system_controllers", "uni_sphere");
                });
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.FacultyAnnouncementImage", b =>
                {
                    b.HasOne("UniSphere.Api.Entities.FacultyAnnouncement", "FacultyAnnouncement")
                        .WithMany("Images")
                        .HasForeignKey("FacultyAnnouncementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_faculty_announcement_images_faculty_announcements_faculty_a");

                    b.Navigation("FacultyAnnouncement");
                });
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.Lecture", b =>
                {
                    b.HasOne("UniSphere.Api.Entities.Professor", "Professor")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_lectures_professors_professor_id");
                    ...
                    b.HasOne("UniSphere.Api.Entities.Subject", "Subject")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_lectures_subjects_subject_id");
