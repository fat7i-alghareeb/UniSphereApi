...
namespace UniSphere.Api.Migrations.Identity
{
    ...
    [Migration("20250624210842_no_idea")]
    partial class no_idea
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid?>("SystemControllerId")
                        .HasColumnType("uuid")
                        .HasColumnName("system_controller_id");
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UniSphere.Api.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UniSphere.Api.Entities.RefreshToken", b =>
                {
                    b.HasOne("UniSphere.Api.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
